...
data class DeclarationWithRelation(val declaration: FirMemberDeclaration, private val relation: RelationToType) {
...
fun ConeKotlinType.leastPermissiveDescriptor(session: FirSession, base: FirEffectiveVisibility) =
